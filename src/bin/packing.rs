...
use uranv2::packing::{save_lifetimes, GraphPacker, IterativeUnpacker, NaiveUnpacker, EfficientUnpacker, accept_all, maximum_length_500, maximum_length_50_level, accept_none, maximum_error};
...
pub fn main() {
    ...
    let lifetimes = packer.pack(maximum_error);
